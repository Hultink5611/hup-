...
const ACTIVITIES = [
  ...
  { id: 5,  name: "Attractiepark Slagharen", plaats: "Slagharen", category: "avontuur", min_age: 3, max_age: 99, prijs: 30, indoor_friendly: false, lat: 52.6175, lng: 6.5300, duur: "hele dag", rating: 4.1, foto: "https://upload.wikimedia.org/wikipedia/commons/3/3a/Attractiepark_Slagharen_Kettenkarussell.jpg", emoji: "🎢", desc: "Western-attractiepark met achtbanen, ponyshow en waterpret." },
  ...
  { id: 10, name: "Avonturenpark Hellendoorn", plaats: "Hellendoorn", category: "avontuur", min_age: 3, max_age: 99, prijs: 33, indoor_friendly: false, lat: 52.3850, lng: 6.4670, duur: "hele dag", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/8/86/Hellendoorn3.JPG", emoji: "🎢", desc: "Attractiepark met achtbanen, dwaaltuin en waterattracties." },
  ...
  { id: 13, name: "Natuurdiorama Holterberg", plaats: "Holten", category: "museum", min_age: 3, max_age: 99, prijs: 9, indoor_friendly: true, lat: 52.2880, lng: 6.4250, duur: "1–2 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/c/ce/Natuurdiorama_Holterberg_%282%29.JPG", emoji: "🦌", desc: "Duizend dieren in levensechte diorama's, met buitenspeelbos." },
  ...
  { id: 16, name: "Dinoland Zwolle", plaats: "Zwolle", category: "avontuur", min_age: 3, max_age: 12, prijs: 17, indoor_friendly: false, lat: 52.4900, lng: 6.0700, duur: "halve dag", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/6/66/2021-08-05_Dinoland_Zwolle_ZvD_10.jpg", emoji: "🦕", desc: "Dinopark met levensechte dino's, fossielen zoeken en speeltuin (seizoen)." },
  ...
  { id: 18, name: "Nederlands Bakkerijmuseum", plaats: "Hattem", category: "museum", min_age: 4, max_age: 99, prijs: 12, indoor_friendly: true, lat: 52.4750, lng: 6.0630, duur: "1–2 uur", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Kerkhofstraat_16%2C_Hattem.jpg", emoji: "🥨", desc: "Zelf koekjes bakken in een levend bakkerijmuseum." },
  ...
  // — Twente —
  { id: 22, name: "De Museumfabriek", plaats: "Enschede", category: "museum", min_age: 4, max_age: 99, prijs: 13, indoor_friendly: true, lat: 52.2200, lng: 6.8900, duur: "2–3 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/4/4e/Twentse_Welle_Tower.JPG", emoji: "🦣", desc: "Doe-museum met natuur, techniek en een echt mammoetskelet." },
  ...
  { id: 34, name: "Fluisterboot huren in Giethoorn", plaats: "Giethoorn", category: "water", min_age: 0, max_age: 99, prijs: 10, indoor_friendly: false, lat: 52.7380, lng: 6.0780, duur: "halve dag", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/b/b3/Elektroboot_Berlare_Donkmeer.jpg", emoji: "🛶", desc: "Zelf varen door 'het Venetië van het noorden' — ± €35 per boot (max 4 pers.)." },
  ...
  { id: 38, name: "WILDLANDS Adventure Zoo", plaats: "Emmen", category: "dieren", min_age: 0, max_age: 99, prijs: 32, indoor_friendly: true, lat: 52.7850, lng: 6.8970, duur: "hele dag", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/8/82/Raadhuisplein%2C_Emmen_-_2018.jpg", emoji: "🐘", desc: "Belevenis-dierentuin met jungle, savanne en poolwereld." },
  ...
  { id: 55, name: "Belevingspad Boswachterij Staphorst", plaats: "Staphorst", category: "natuur", min_age: 3, max_age: 12, prijs: 0, indoor_friendly: false, lat: 52.614, lng: 6.220, duur: "1–2 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/f/f1/ZwarteDennen9.jpg", emoji: "🌲", desc: "Gratis kinderwandelpad met doolhof, herriehut en kleurenkamer." },
  ...
  { id: 61, name: "Recreatiepark Het Rutbeek", plaats: "Enschede", category: "water", min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.198, lng: 6.826, duur: "2–4 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/7/7a/2012-10-21_Rutbeek_triatlon2.jpg", emoji: "🏖️", desc: "Gratis recreatieplas met strand, speeltuin en klimbos." },
  ...
  { id: 63, name: "Oyfo Techniekmuseum", plaats: "Hengelo", category: "museum", min_age: 4, max_age: 17, prijs: 10, indoor_friendly: true, lat: 52.270, lng: 6.792, duur: "2–3 uur", rating: 4.5, foto: "https://upload.wikimedia.org/wikipedia/commons/a/ae/Oyfo_Voorgevel.jpg", emoji: "🔬", desc: "Hands-on techniekmuseum: experimenteren, bouwen en ontdekken." },
  ...
  { id: 89, name: "Buitencentrum & Sterrenwacht Sallandse Heuvelrug", plaats: "Nijverdal", category: "museum", min_age: 6, max_age: 99, prijs: 4, indoor_friendly: true, lat: 52.358, lng: 6.464, duur: "1–2 uur", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/6/65/Bezoekerscentrum_Nationaal_Park_Sallandse_Heuvelrug_%282%29.JPG", emoji: "🔭", desc: "Planetariumshow en sterrenwacht, met speelbospad ernaast." },
  ...
  { id: 92, name: "Plopsa Indoor Coevorden", plaats: "Dalen", category: "binnenpret", min_age: 2, max_age: 10, prijs: 28, indoor_friendly: true, lat: 52.670, lng: 6.750, duur: "hele dag", rating: 4.1, foto: "https://upload.wikimedia.org/wikipedia/commons/9/99/PlopsaIndoorCoevorden.jpg", emoji: "🎠", desc: "Studio 100-attractiepark met Kabouter Plop en K3." },
  ...
  { id: 96, name: "Boomkroonpad Drouwen", plaats: "Drouwen", category: "natuur", min_age: 4, max_age: 99, prijs: 5, indoor_friendly: false, lat: 52.910, lng: 6.770, duur: "halve dag", rating: 4.5, foto: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Boomkroonpad.jpg", emoji: "🌳", desc: "Wandelpad 22 meter hoog tussen de boomtoppen op de Hondsrug." },
  { id: 97, name: "Hunebedcentrum", plaats: "Borger", category: "museum", min_age: 4, max_age: 99, prijs: 8, indoor_friendly: true, lat: 52.930, lng: 6.800, duur: "halve dag", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/2/25/Hunebedcentrum_Borger2_Aldo_van_Eyck.jpg", emoji: "🪨", desc: "Interactief museum over de prehistorie en hunebedden." },
  ...
  { id: 100, name: "Julianatoren", plaats: "Apeldoorn", category: "speeltuin", min_age: 2, max_age: 12, prijs: 31, indoor_friendly: false, lat: 52.220, lng: 5.940, duur: "hele dag", rating: 4.5, foto: "https://upload.wikimedia.org/wikipedia/commons/b/b5/Koningin_Juliana_Toren_%286488535611%29.jpg", emoji: "🎡", desc: "Kinderpretpark met Kabouterwonderland en 60+ attracties." },
  { id: 101, name: "Veluwsche Stoomtrein", plaats: "Beekbergen", category: "museum", min_age: 2, max_age: 99, prijs: 11, indoor_friendly: false, lat: 52.170, lng: 5.970, duur: "halve dag", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/0/09/Station_Beekbergen.jpg", emoji: "🚂", desc: "Historische stoomtrein door de Veluwse bossen." },
  { id: 102, name: "Paleis Het Loo — Juniorpaleis", plaats: "Apeldoorn", category: "museum", min_age: 3, max_age: 12, prijs: 10, indoor_friendly: true, lat: 52.240, lng: 5.940, duur: "halve dag", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Paleis_Het_Loo_Apeldoorn.jpg", emoji: "👑", desc: "Koninklijk paleis met een ondergronds Juniorpaleis voor kinderen." },
  ...
  { id: 112, name: "Bierbrouwerij Mommeriete", plaats: "Gramsbergen", category: "eten", audience: ["vrienden", "partner", "senioren"], min_age: 18, max_age: 99, prijs: 23, indoor_friendly: true, lat: 52.61, lng: 6.655, duur: "1–2 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/8/84/Mommeriete_Brouwerij_%40_Borefts_2012.jpg", emoji: "🍺", desc: "Lokale brouwerij met rondleiding, proeverij en biertuin" },
  ...
  { id: 131, name: "Museum de Fundatie", plaats: "Zwolle", category: "museum", audience: ["partner", "senioren", "alleen", "vrienden"], min_age: 12, max_age: 99, prijs: 18, indoor_friendly: true, lat: 52.515, lng: 6.092, duur: "1–2 uur", rating: 4.5, foto: "https://upload.wikimedia.org/wikipedia/commons/0/0e/2016_Museum_de_Fundatie_Zwolle.jpg", emoji: "🎨", desc: "Eigenzinnig kunstmuseum met spectaculaire koepel op het dak" },
  ...
  { id: 133, name: "Rijksmuseum Twenthe", plaats: "Enschede", category: "museum", audience: ["partner", "senioren", "alleen", "vrienden"], min_age: 14, max_age: 99, prijs: 17, indoor_friendly: true, lat: 52.219, lng: 6.884, duur: "1–2 uur", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/9/98/Enschede_-_2021_-_Rijksmuseum_Twenthe.jpg", emoji: "🖼️", desc: "Rijke kunstcollectie van Middeleeuwen tot heden" },
  ...
  { id: 140, name: "Bolwerksmolen", plaats: "Deventer", category: "bezienswaardigheid", audience: ["partner", "senioren", "vrienden", "gezin"], min_age: 6, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.258, lng: 6.163, duur: "1 uur", rating: 4.1, foto: "https://upload.wikimedia.org/wikipedia/commons/9/9d/Bolwerksmolen.jpg", emoji: "⚙️", desc: "Enige windhoutzaagmolen van Overijssel, draait wekelijks" },
  { id: 141, name: "Zwolse Theaters Odeon & De Spiegel", plaats: "Zwolle", category: "cultuur", audience: ["partner", "vrienden", "senioren", "gezin"], min_age: 6, max_age: 99, prijs: 25, indoor_friendly: true, lat: 52.514, lng: 6.093, duur: "2–3 uur", rating: 4.3, foto: "https://upload.wikimedia.org/wikipedia/commons/1/1a/Blijmarkt_25%2C_Zwolle.jpg", emoji: "🎭", desc: "Twee theaterzalen met honderden voorstellingen per jaar" },
  { id: 142, name: "Peperbus Onze Lieve Vrouwetoren", plaats: "Zwolle", category: "bezienswaardigheid", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 8, max_age: 75, prijs: 4, indoor_friendly: false, lat: 52.514, lng: 6.089, duur: "1 uur", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/1/1f/De_Peperbus_van_Zwolle.jpg", emoji: "🗼", desc: "Iconische 14e-eeuwse toren beklimmen voor panorama over Zwolle" },
  ...
  { id: 145, name: "Drents Museum", plaats: "Assen", category: "museum", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 12, max_age: 99, prijs: 18, indoor_friendly: true, lat: 52.993, lng: 6.565, duur: "2–3 uur", rating: 4.6, foto: "https://upload.wikimedia.org/wikipedia/commons/3/3c/Drents_Museum.jpg", emoji: "🏺", desc: "Topmuseum met veenlijken en wisselende internationale exposities" },
  ...
  { id: 148, name: "Kunstwegen Vechtdal", plaats: "Vechtdal", category: "bezienswaardigheid", audience: ["partner", "vrienden", "senioren", "alleen"], min_age: 12, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.52, lng: 6.4, duur: "2–4 uur", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Nordhorn_Visch01.JPG", emoji: "🚴", desc: "Openluchtmuseum: kunstwerken fietsend langs de Vecht" },
  ...
  { id: 185, name: "Nationaal Park Weerribben-Wieden", plaats: "Sint Jansklooster", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.7333, lng: 6.0167, duur: "2–4 uur", rating: 4.7, foto: "https://upload.wikimedia.org/wikipedia/commons/b/ba/NP-WeerribbenWiedenKaart.jpg", emoji: "🛶", desc: "Grootste laagveengebied met riet, kanalen en vogels" },
  { id: 186, name: "Nationaal Park Sallandse Heuvelrug", plaats: "Holten", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.2833, lng: 6.4167, duur: "2–3 uur", rating: 4.6, foto: "https://upload.wikimedia.org/wikipedia/commons/9/98/Sallandse_Heuvelrug%284%29.jpg", emoji: "🌿", desc: "Heide, vennen en panoramapunt met zicht tot Deventer" },
  ...
  { id: 188, name: "Landgoed Twickel", plaats: "Ambt Delden", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.2667, lng: 6.7167, duur: "2–3 uur", rating: 4.7, foto: "https://upload.wikimedia.org/wikipedia/commons/f/fe/Kasteel_Twickel.JPG", emoji: "🏰", desc: "Grootste erfgoedlandgoed van Overijssel met wandelpaden" },
  ...
  { id: 191, name: "Watermolen Singraven", plaats: "Denekamp", category: "bezienswaardigheid", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: true, lat: 52.3833, lng: 7, duur: "1–2 uur", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/c/c5/Huis_Singraven_HDR.jpg", emoji: "⚙️", desc: "Werkende koren- en zaagmolen op landgoed sinds 1448" },
  ...
  { id: 197, name: "Wierdense Veld Hoogveen", plaats: "Wierden", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.3583, lng: 6.4583, duur: "1–2 uur", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/9/93/Natura2000_-_Wierdense_Veld.png", emoji: "🌾", desc: "Zeldzaam levend hoogveen met heide en wollegras" },
  ...
  { id: 199, name: "Nationaal Park Drents-Friese Wold", plaats: "Diever", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.85, lng: 6.3167, duur: "2–4 uur", rating: 4.6, foto: "https://upload.wikimedia.org/wikipedia/commons/7/77/NP-DrentsFrieseWoldKaart.jpg", emoji: "🌲", desc: "Groot aaneengesloten bos met heide en uitkijktoren" },
  ...
  { id: 202, name: "Landgoed De Wiersse Tuinen", plaats: "Vorden", category: "natuur", audience: ["partner", "senioren", "vrienden", "alleen"], min_age: 12, max_age: 99, prijs: 8, indoor_friendly: false, lat: 52.1, lng: 6.3167, duur: "1–2 uur", rating: 4.6, foto: "https://upload.wikimedia.org/wikipedia/commons/d/de/Wiersse.jpg", emoji: "🌸", desc: "Monumentale historische tuin van 16 hectare" },
  ...
  { id: 204, name: "Lemelerberg Heide & Bos", plaats: "Lemele", category: "natuur", audience: ["partner", "vrienden", "alleen"], min_age: 0, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.4667, lng: 6.3583, duur: "2–3 uur", rating: 4.4, foto: "https://upload.wikimedia.org/wikipedia/commons/f/f3/Archemerberg-natuur-OpenTopo.jpg", emoji: "🥾", desc: "Eindeloze heide, zandvlaktes en loofbos in het Vechtdal" },
  ...
  { id: 243, name: "Kamper Kogge & Koggewerf", plaats: "Kampen", category: "cultuur", audience: ["partner", "senioren", "vrienden", "gezin"], min_age: 6, max_age: 99, prijs: 0, indoor_friendly: false, lat: 52.555, lng: 5.915, duur: "1–2 uur", rating: 4.2, foto: "https://upload.wikimedia.org/wikipedia/commons/c/c9/Kampen_kogge.jpg", emoji: "⚓", desc: "Enige varende kogge van Nederland, werf op donderdag open" },
  ...
  { id: 249, name: "Nationaal Gevangenismuseum", plaats: "Veenhuizen", category: "cultuur", audience: ["partner", "senioren", "vrienden", "alleen", "gezin"], min_age: 10, max_age: 99, prijs: 15, indoor_friendly: true, lat: 52.942, lng: 6.427, duur: "2–3 uur", rating: 4.5, foto: "https://upload.wikimedia.org/wikipedia/commons/1/10/Het_Nationaal_Gevangenismuseum.jpg", emoji: "🔒", desc: "UNESCO-erfgoed: authentieke gevangenis met boevenbus en rondleiding" },
...
function Hero({ a, h = 200, rounded = "rounded-t-[26px]" }) {
  ...
  const photo = a.foto && imgOk;
  return (
    <div className={"relative overflow-hidden " + rounded} style={{ height: h, background: `linear-gradient(135deg, ${c.g[0]}, ${c.g[1]})` }}>
      {!photo && <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "radial-gradient(circle at 1px 1px, rgba(255,255,255,.5) 1.5px, transparent 0)", backgroundSize: "22px 22px" }} />}
      {!photo && <HeroScene category={a.category} seed={a.id} />}
      {!photo && (
      ...
      {a.foto && (
        <img src={a.foto} alt={a.name} loading="lazy" onError={() => setImgOk(false)}
          className={"absolute inset-0 w-full h-full object-cover " + (imgOk ? "" : "hidden")} />
      )}
      {photo && <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(0,0,0,.30), rgba(0,0,0,0) 45%)" }} />}
      {photo && <span className="absolute bottom-1.5 right-2 text-[9px] text-white/75">foto via Wikimedia</span>}
  ...
  return (
    <div className="rise bg-white rounded-3xl shadow-card overflow-hidden flex">
      <div className="w-24 shrink-0 relative" style={{ background: `linear-gradient(135deg, ${CAT[a.category].g[0]}, ${CAT[a.category].g[1]})` }}>
        ...
        {a.foto && <img src={a.foto} alt="" loading="lazy" className="absolute inset-0 w-full h-full object-cover" onError={(e) => { e.currentTarget.remove(); }} />}
      </div>
          ...
          {detail && !empty && (
            <button onClick={() => setDetail(detail)} className="rise mt-8 w-full bg-white rounded-3xl shadow-card overflow-hidden flex text-left">
              <div className="w-24 shrink-0 relative" style={{ background: `linear-gradient(135deg, ${CAT[detail.category].g[0]}, ${CAT[detail.category].g[1]})` }}>
                ...
                {detail.foto && <img src={detail.foto} alt="" loading="lazy" className="absolute inset-0 w-full h-full object-cover" onError={(e) => { e.currentTarget.remove(); }} />}
              </div>
